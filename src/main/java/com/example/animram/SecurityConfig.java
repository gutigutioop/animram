...
import com.example.animram.filter.FormAuthenticationProvider;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] URLS = {
        "/css/**", "/images/**", "/scripts/**", "/favicon.ico"
    };
    ...
    */
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
          .antMatchers("/", "/login", "/logout-complete", "/users/new", "/users", "/error", "/css/**", "/images/**", "/scripts/**")
          .permitAll()
          ...
          // form
          .and().formLogin().loginPage("/login").defaultSuccessUrl("/top").failureUrl("/login-failure")
          ;
    }
